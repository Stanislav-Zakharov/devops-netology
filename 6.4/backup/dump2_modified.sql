...
ALTER INDEX public.orders_pkey ATTACH PARTITION public.orders_1_pkey;
...
ALTER INDEX public.orders_pkey ATTACH PARTITION public.orders_2_pkey;

-------------------------------------------------------------------
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_title_uk UNIQUE (title, price);

ALTER TABLE ONLY public.orders_1
    ADD CONSTRAINT orders_1_title_uk UNIQUE (title, price);

ALTER TABLE ONLY public.orders_2
    ADD CONSTRAINT orders_2_title_uk UNIQUE (title, price);

ALTER INDEX public.orders_title_uk ATTACH PARTITION public.orders_1_title_uk;
ALTER INDEX public.orders_title_uk ATTACH PARTITION public.orders_2_title_uk;
